...
public class SplitLogs {
    public static void main(String[] args) throws IOException {
        ...
        if (args[0].equals("--help")) { //передача параметра --help
            System.out.println("\n" +
                    "Программа осуществляет разбивку переданного файла на " + count_file + " файлов. \n" +
                    ...
                    "Переданный файл с логами будет разбит на " + count_file + " файлов. Новыйе файлы будут созданы в директории, которая уазывается вторым параметром.\n" +
                    "Если создаваемый файл уже сующествуюет в данной директории, то произойдет перезапись файла.\n" +
