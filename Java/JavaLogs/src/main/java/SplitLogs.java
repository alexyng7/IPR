    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args[0].equals("--help")) {
            System.out.println("Программа запускаетсяа из командной строки при помощи команды: \n" +
                    ...
                    "Переданный файл с логами будет разбит на 5 файлов. Новыйе файлы будут созданы в той же директории, что и исходный файл. \n" +
                    "Если файл с заданным именем уже сующествуюет, то произдойдет перезапись файла.\n");
        }else {
