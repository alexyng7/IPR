...
count(*) as "кол. тестеров"
from users
where role = 'ROLE_CUSTOMER' and updated BETWEEN '2022-01-01 0:00:00' AND '2022-12-31 23:59:59'
group by месяц
order by "кол. тестеров" desc
...
count(*) as "кол. тестеров"
from users
where role = 'ROLE_CUSTOMER' and updated BETWEEN '2022-07-01 0:00:00' AND '2022-07-31 23:59:59'
group by пик_день
order by пик_день
...
count(*) as "кол. тестеров"
from users
where role = 'ROLE_CUSTOMER' and updated BETWEEN '2022-07-15 0:00:00' AND '2022-07-15 23:59:59'
group by день, час
order by час
...
count(*) as "кол. тестеров"
from users
where role = 'ROLE_CUSTOMER' and updated BETWEEN '2022-07-15 22:00:00' AND '2022-07-15 22:59:59'
group by час, минута 
order by час, минута